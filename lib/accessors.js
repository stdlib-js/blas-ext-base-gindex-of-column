...
*
* var A = [ 1.0, 3.0, 0.0, 2.0, 4.0, 0.0 ]; // => [ [ 1.0, 3.0, 0.0 ], [ 2.0, 4.0, 0.0 ] ]
* var x = [ 3.0, 4.0 ];
*
* var out = gindexOfColumn( 2, 3, arraylike2object( toAccessorArray( A ) ), 3, 1, 0, arraylike2object( toAccessorArray( x ) ), 1, 0 );
* // returns 1
*
* @example
* var toAccessorArray = require( '@stdlib/array-base-to-accessor-array' );
* var arraylike2object = require( '@stdlib/array-base-arraylike2object' );
*
* var A = [ 1.0, 2.0, 3.0, 4.0, 0.0, 0.0 ]; // => [ [ 1.0, 3.0, 0.0 ], [ 2.0, 4.0, 0.0 ] ]
* var x = [ 3.0, 4.0 ];
*
* var out = gindexOfColumn( 2, 3, arraylike2object( toAccessorArray( A ) ), 1, 2, 0, arraylike2object( toAccessorArray( x ) ), 1, 0 );
* // returns 1
*
* @example
* var toAccessorArray = require( '@stdlib/array-base-to-accessor-array' );
...
* // returns -1
*/
function gindexOfColumn( M, N, A, strideA1, strideA2, offsetA, x, strideX, offsetX ) { // eslint-disable-line max-len
	var matches;
	var abuf;
	var xbuf;
	var aget;
	...
	// Create an array for tracking which columns contain matching elements:
	matches = ones( N );
