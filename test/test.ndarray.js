...
tape( 'the function has an arity of 9', function test( t ) {
	t.strictEqual( gindexOfColumn.length, 9, 'returns expected value' );
	t.end();
});
...
tape( 'the function returns an invalid index when M is less than or equal to zero (row-major)', function test( t ) {
	...
	data = ROW_MAJOR_DATA;
	out = gindexOfColumn( data.order, 0, data.N, data.A, data.strideA1, data.strideA2, data.offsetA, data.x, data.strideX, data.offsetX );
...
tape( 'the function returns an invalid index when N is less than or equal to zero (row-major)', function test( t ) {
	...
	data = ROW_MAJOR_DATA;
	out = gindexOfColumn( data.order, data.M, 0, data.A, data.strideA1, data.strideA2, data.offsetA, data.x, data.strideX, data.offsetX );
...
tape( 'the function returns the index of the first column matching a search vector (row-major)', function test( t ) {
	...
	data = ROW_MAJOR_DATA;
	out = gindexOfColumn( data.M, data.N, data.A, data.strideA1, data.strideA2, data.offsetA, data.x, data.strideX, data.offsetX );
